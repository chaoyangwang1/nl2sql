...
from app.agent.nodes.retrieve_few_shot import retrieve_few_shot
...
graph_builder.add_node("retrieve_few_shot", retrieve_few_shot)
...
graph_builder.add_edge("add_extra_context", "retrieve_few_shot")
graph_builder.add_edge("retrieve_few_shot", "generate_sql")
...
if __name__ == '__main__':
    async def test():
        ...
        async with meta_mysql_client_manager.session_factory() as meta_session, dw_mysql_client_manager.session_factory() as dw_session:
            ...
            few_shot_repo = FewShotQdrantRepository(qdrant_client_manager.client)
            ...
            context = DataAgentContext(
                ...
                few_shot_repository=few_shot_repo,
            )
